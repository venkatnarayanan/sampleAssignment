...
define('ember-basic-dropdown/components/basic-dropdown', ['exports', 'ember-basic-dropdown/templates/components/basic-dropdown', 'ember-basic-dropdown/utils/computed-fallback-if-undefined', 'ember-basic-dropdown/utils/calculate-position'], function (exports, _emberBasicDropdownTemplatesComponentsBasicDropdown, _emberBasicDropdownUtilsComputedFallbackIfUndefined, _emberBasicDropdownUtilsCalculatePosition) {
  ...
  exports['default'] = Ember.Component.extend({
    ...
    horizontalPosition: (0, _emberBasicDropdownUtilsComputedFallbackIfUndefined['default'])('auto'), // auto-right | right | center | left
    ...
    calculatePosition: (0, _emberBasicDropdownUtilsComputedFallbackIfUndefined['default'])(_emberBasicDropdownUtilsCalculatePosition['default']),
...
define('ember-basic-dropdown/components/basic-dropdown/content', ['exports', 'ember-basic-dropdown/templates/components/basic-dropdown/content', 'ember-basic-dropdown/utils/computed-fallback-if-undefined', 'ember-basic-dropdown/utils/calculate-position', 'ember-basic-dropdown/utils/scroll-helpers'], function (exports, _emberBasicDropdownTemplatesComponentsBasicDropdownContent, _emberBasicDropdownUtilsComputedFallbackIfUndefined, _emberBasicDropdownUtilsCalculatePosition, _emberBasicDropdownUtilsScrollHelpers) {
  'use strict';
   ...
   */
  function dropdownIsValidParent(_x, _x2) {
    var _left;
    ...
    _function: while (_again) {
      ...
      if (closestDropdown) {
        ...
        if (_left = parentDropdown && parentDropdown.attributes.id.value === dropdownId) {
          return _left;
        }
        ...
        _x2 = dropdownId;
        _again = true;
        closestDropdown = trigger = parentDropdown = undefined;
        continue _function;
      } else {
        return false;
      }
  ...
  exports['default'] = Ember.Component.extend({
    ...
    // CPs
    _contentTagName: (0, _emberBasicDropdownUtilsComputedFallbackIfUndefined['default'])('div'),
    ...
    wheelHandler: function wheelHandler(event) {
      ...
      if (element.contains(event.target) || element === event.target) {
        ...
        var availableScroll = (0, _emberBasicDropdownUtilsScrollHelpers.getAvailableScroll)(event.target, element);
        ...
        if (event.deltaMode !== 0) {
          ...
          var scrollLineHeight = (0, _emberBasicDropdownUtilsScrollHelpers.getScrollLineHeight)();
        ...
        if (event.defaultPrevented && (deltaX || deltaY)) {
          (0, _emberBasicDropdownUtilsScrollHelpers.distributeScroll)(deltaX, deltaY, event.target, element);
        }
      } else {
    ...
    getScrollableAncestors: function getScrollableAncestors() {
      ...
      if (this.triggerElement) {
        var nextScrollable = (0, _emberBasicDropdownUtilsCalculatePosition.getScrollParent)(this.triggerElement.parentNode);
        while (nextScrollable && nextScrollable.tagName.toUpperCase() !== 'BODY' && nextScrollable.tagName.toUpperCase() !== 'HTML') {
          ...
          nextScrollable = (0, _emberBasicDropdownUtilsCalculatePosition.getScrollParent)(nextScrollable.parentNode);
        }
      }
...
define('ember-basic-dropdown/components/basic-dropdown/trigger', ['exports', 'ember-basic-dropdown/templates/components/basic-dropdown/trigger', 'ember-basic-dropdown/utils/computed-fallback-if-undefined'], function (exports, _emberBasicDropdownTemplatesComponentsBasicDropdownTrigger, _emberBasicDropdownUtilsComputedFallbackIfUndefined) {
  'use strict';
  ...
  exports['default'] = Ember.Component.extend({
    ...
    role: (0, _emberBasicDropdownUtilsComputedFallbackIfUndefined['default'])('button'),
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        ...
        var child1 = (function () {
          return {
            ...
            statements: [["content", "yield", ["loc", [null, [12, 6], [12, 15]]], 0, 0, 0, 0]],
            locals: [],
            templates: []
          };
        })();
      ...
      return {
        ...
        statements: [["block", "ember-wormhole", [], ["to", ["subexpr", "@mut", [["get", "to", ["loc", [null, [2, 23], [2, 25]]], 0, 0, 0, 0]], [], [], 0, 0], "renderInPlace", ["subexpr", "@mut", [["get", "renderInPlace", ["loc", [null, [2, 40], [2, 53]]], 0, 0, 0, 0]], [], [], 0, 0], "class", "ember-basic-dropdown-content-wormhole-origin"], 0, null, ["loc", [null, [2, 2], [14, 21]]]]],
        locals: [],
        templates: [child0]
      };
    })();
    var child1 = (function () {
      return {
        ...
        statements: [["attribute", "id", ["get", "dropdownId", ["loc", [null, [16, 12], [16, 22]]], 0, 0, 0, 0], 0, 0, 0, 0]],
        locals: [],
        templates: []
      };
    })();
    return {
      ...
      statements: [["block", "if", [["get", "dropdown.isOpen", ["loc", [null, [1, 6], [1, 21]]], 0, 0, 0, 0]], [], 0, 1, ["loc", [null, [1, 0], [17, 7]]]]],
      locals: [],
      templates: [child0, child1]
    };
  })());
  ...
  exports['default'] = Ember.Component.extend({
    ...
    _destination: Ember.computed('destinationElement', 'destinationElementId', 'renderInPlace', function () {
      ...
      if (destinationElementId) {
        return (0, _emberWormholeUtilsDom.findElementById)(this._dom, destinationElementId);
      }
      // no element found
      return null;
    }),
...
define('model-fragments/array/fragment', ['exports', 'ember', 'model-fragments/array/stateful', 'model-fragments/fragment', 'model-fragments/util/instance-of-type', 'model-fragments/util/map'], function (exports, _ember, _modelFragmentsArrayStateful, _modelFragmentsFragment, _modelFragmentsUtilInstanceOfType, _modelFragmentsUtilMap) {
  'use strict';
  ...
  */
  ...
  function normalizeFragmentArray(array, content, objs, canonical) {
    ...
    return (0, _modelFragmentsUtilMap['default'])(objs, function (data, index) {
      _ember['default'].assert("You can only add '" + get(array, 'type') + "' fragments or object literals to this property", typeOf(data) === 'object' || (0, _modelFragmentsUtilInstanceOfType['default'])(store.modelFor(get(array, 'type')), data));

      if ((0, _modelFragmentsFragment.isFragment)(data)) {
        fragment = data;

        var owner = (0, _modelFragmentsFragment.internalModelFor)(fragment)._owner;

        _ember['default'].assert("Fragments can only belong to one owner, try copying instead", !owner || owner === record);

        if (!owner) {
          (0, _modelFragmentsFragment.setFragmentOwner)(fragment, record, key);
        }
      } else {
  ...
  */
  var FragmentArray = _modelFragmentsArrayStateful['default'].extend({
    /**
...
define('model-fragments/fragment', ['exports', 'ember', 'model-fragments/ext'], function (exports, _ember, _modelFragmentsExt) {
  'use strict';

  exports.getActualFragmentType = getActualFragmentType;
  exports.internalModelFor = internalModelFor;
  exports.setFragmentOwner = setFragmentOwner;
  ...
  */
  ...
  /**
    ...
    @uses Ember.Copyable
  */
  var Fragment = _modelFragmentsExt.Model.extend(_ember['default'].Comparable, _ember['default'].Copyable, {
    /**
    ...
    */
    compare: function compare(f1, f2) {
      return f1 === f2 ? 0 : 1;
    },
    ...
    */
    copy: function copy() {
      ...
      type.eachAttribute(function (name) {
        props[name] = _copy(get(this, name));
      }, this);
    ...
    */
    ...
    fragmentOwnerProperties: _ember['default'].computed(function () {
      var props = [];
  ...
  function setFragmentOwner(fragment, record, key) {
    ...
    _ember['default'].assert("To preserve rollback semantics, fragments can only belong to one owner. Try copying instead", !internalModel._owner || internalModel._owner === record);
...
define('model-fragments/states', ['exports', 'ember', 'ember-data/-private/system/model/states'], function (exports, _ember, _emberDataPrivateSystemModelStates) {
  'use strict';
  ...
  */
  ...
  var didSetProperty = _emberDataPrivateSystemModelStates['default'].loaded.saved.didSetProperty;
  var propertyWasReset = _emberDataPrivateSystemModelStates['default'].loaded.updated.uncommitted.propertyWasReset;
...
define("model-fragments/util/instance-of-type", ["exports"], function (exports) {
  "use strict";
...
define("model-fragments/util/map", ["exports"], function (exports) {
  "use strict";
...
define("model-fragments/version", ["exports"], function (exports) {
  "use strict";
