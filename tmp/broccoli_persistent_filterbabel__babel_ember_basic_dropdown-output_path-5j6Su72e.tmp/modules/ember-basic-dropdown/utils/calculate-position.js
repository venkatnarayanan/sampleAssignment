...
*/
export default function (_, _2, _destination, _ref) {
...
export function calculateWormholedPosition(trigger, content, destination, _ref2) {
...
export function calculateInPlacePosition(trigger, content, destination, _ref3 /*, matchTriggerWidth, previousHorizontalPosition, previousVerticalPosition */) {
